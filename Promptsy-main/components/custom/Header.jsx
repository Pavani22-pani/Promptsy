  ...
  return (
    ...
    <div className="hidden sm:flex justify-between items-center">
      ...
      <Link href={'/'} className="flex items-center gap-2">
        <div className="w-[40px] h-[40px] overflow-hidden rounded-full pt-2">
          <Image src="/logo3.png" alt="logo" width={300} height={300} />
        </div>
        <div className="font-bold text-3xl">Promptsy</div>
      </Link>
